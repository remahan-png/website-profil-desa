    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-4 text-lg">Informasi terbaru seputar kegiatan dan perkembangan desa kami.</p>
        </div>
        
        {!news || news.length === 0 ? (
          <div className="bg-white p-8 rounded-xl shadow-md text-center">
            <p className="text-gray-500 text-lg font-medium">Belum ada berita yang tersedia saat ini.</p>
          </div>
        ) : (
