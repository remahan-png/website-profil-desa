...
export default function KontakClient({ contactInfo }) {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setStatus("success");
      e.target.reset();
      // Set status kembali ke "" setelah beberapa saat
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">{contactInfo?.lokasi}</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="bg-red-100 p-3 rounded-2xl text-red-600 text-xl">📞</div>
              <div>
                ...
                <p className="text-gray-600">{contactInfo?.wa}</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
